# Generated by Django 4.0.2 on 2022-05-10 03:01
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('country', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='flutters', to='world.country')),
        ...
        migrations.AddField(
            model_name='user',
            name='been',
            field=models.ManyToManyField(related_name='countries_been', to='world.Country'),
        ),
        migrations.AddField(
            model_name='user',
            name='following',
